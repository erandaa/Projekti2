<?php 
    ...
    include_once '../logic/MessageMapper.php';
                ...
                <tbody>
                    <?php foreach($productList as $product){ ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo "../logic/modifications.php?action=delete-product&prod-id=".$product['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini produktin?');">Fshij
                                </a>
                            </td>
                            <td>
                                <?php if($product['is_promoted'] == 0) { ?>
                                    <a href="<?php echo "../logic/modifications.php?action=promote-product&prod-id=".$product['id']; ?>">Promovo
                                    </a>
                                <?php } else if($product['is_promoted'] == 1){ ?>
                                    <a href="<?php echo "../logic/modifications.php?action=demote-product&prod-id=".$product['id']; ?>">Largo nga promovimi
                                    </a>
                                <?php }?>
                            </td>
                            <td>
                                <a href="<?php echo "../logic/modifications.php?action=edit-product&prod-id=".$product['id']; ?>">Edito
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <?php } else if (isset($_GET['action']) && $_GET['action'] == 'add-product'){ 
        ...
        <div class="edit-product-main">
            <form method="POST" action="../logicc/upload.php" enctype="multipart/form-data" class="edit-product-card">
                <h2>Shto produkt</h2>
                <hr class="divider">
            ...
            <table class="db-table">
                ...
                <?php foreach($userList as $user){ ?>
                    <tr class="users-email-col">
                        ...
                        <td><a href="<?php echo "../logic/modifications.php?action=delete-user&user-id=".$user['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini përdoruesin?');">Fshij</a></td>
                        <?php if($user['is_admin'] == 1) {?>
                            <td><a href="<?php echo "../logic/modifications.php?action=remove-admin&user-id=".$user['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini përdoruesin si administrator?');">Largo admin</a></td>
                        <?php } else { ?>
                            <td><a href="<?php echo "../logic/modifications.php?action=make-admin&user-id=".$user['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të promovoni përdoruesin në administrator?');">Provomo në admin</a></td>
                        <?php } ?>
                        <td><a href="<?php echo "../logic/modifications.php?action=edit-user&user-id=".$user['id']; ?>">Edito</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>    
                ...
                <tbody>
                    <?php foreach($msgUnread as $msg){ ?>
                        <tr>
                            ...
                            <td><a href="<?php echo "../logic/modifications.php?action=delete-msg&msg-id=".$msg['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini mesazhin?');">Fshij</a></td>
    ...
    <?php } else if(isset($_GET['action']) && $_GET['action'] == 'add-category') { 
        ...
        <div class="edit-product-main">
            <form method="POST" action="../logic/upload.php" enctype="multipart/form-data" class="edit-product-card">
                <h2>Shto kategori</h2>
                <hr class="divider">
                ...
                <tbody>
                    <?php foreach($categories as $category){ ?>
                        <tr>
                            ...
                            <td><a href="<?php echo "../logic/modifications.php?action=delete-category&category=".$category['emri']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini kategorinë?');">Fshij</a></td>
                        </tr>
                    <?php } ?>
                </tbody>                
            </table>
                ...
                <tbody>
                    <?php foreach($sliderImg as $img){ ?>
                        <tr>
                            ...
                            <td><a href="<?php echo "../logic/modifications.php?action=delete-slider-img&img-id=".$img['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini foton?');">Fshij</a></td>
                        </tr>
                    <?php } ?>
                </tbody>                
            </table>
                ...
                <tbody>
                    <?php foreach($brandImages as $img){ ?>
                        <tr>
                            ...
                            <td><a href="<?php echo "../logic/modifications.php?action=delete-brand-img&img-id=".$img['id']; ?>" onclick="return confirm('A jeni të sigurt që dëshironi të fshini foton?');">Fshij</a></td>
                        </tr>
                    <?php } ?>
                </tbody>                
            </table>
