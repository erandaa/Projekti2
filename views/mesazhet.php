<?php 
    ...
    require_once '../logic/MessageMapper.php';
        ...
        <div class="message-card">
            ...
            <p><a href="
                <?php if($msg['is_read'] == 0) 
                    echo "../logic/modifications.php?action=set-read&msg-id=".$msg['id'];
                else if($msg['is_read'] == 1)
                    echo "../logic/modifications.php?action=set-unread&msg-id=".$msg['id'];?>">
